...
Function SpellNumberBR(ByVal MyNumber)
    If MyNumber > 1E+15 Then
        SpellNumberBR = "Error: Number too big"
    Else
    
        Dim Number, Temp, DecimalPlace, Count
        ...
        ' Remove decimal part of MyNumber
        ...
        Do While MyNumber <> ""
            ...
            If Temp <> "" Then
                If MyNumber > 1 Then
                    Number = Temp & Places(Count) & Number
                Else
