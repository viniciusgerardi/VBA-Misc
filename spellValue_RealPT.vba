...
Function SpellCurrencyReal(ByVal MyNumber)
    If MyNumber > 1E+15 Then
        SpellCurrencyReal = "Error: Number too big"
    Else
        ...
        Do While MyNumber <> ""
            ...
            If Temp <> "" Then
                If MyNumber > 1 Then
                    Real = Temp & Places(Count) & Real
                Else
                    Real = Temp & Place(Count) & Real
                End If
            End If
